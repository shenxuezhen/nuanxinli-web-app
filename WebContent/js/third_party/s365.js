...
function getThirdParty(onReady) {
    ...
    var employeeInfo = {
        ...
        company: {    //企业对象
            thirdPartyId: 'DEFS3650030001',   //企业第三方id
            isVendor: 0,              //是否为供应商
            name: 's365',
            vendor: {      //供应商对象
                id: getParam('id'),     //url
...
function heartImg() {
    return '/warm/images/navigation/thatmind365.png';
}

function videoImg() {
    return '/warm/images/navigation/decompression_audio365.png';
}

function magazineImg() {
    return '/warm/images/magazine/biaoqqian_bj365.png';
}

function editHeartImg() {
    return '/warm/images/bbs/levitationbutton365.png';
}
function bbsNiming() {
    return '/warm/images/bbs/niming365.jpg';
}
function audioButtonImg() {
    return '/warm/images/audio/pausebutton_small365.png';
}
function transitionPrice(str) {
    return new Decimal(str).multiply(10).valueOf()+"积分";
}
function channel() {
    return 's365';
}
